...
```powershell
..\..\tools\Invoke-VmInvestigation.ps1 -WorkspaceId <LAW_WORKSPACE_ID> -ResourceGroup rg-srelabvm -VmName srelabvm-vm01 -Scenario disk-full
```
...
..\..\tools\Invoke-ApprovedRemediation.ps1 -Action cleanup-disk -ResourceGroup rg-srelabvm -VmName srelabvm-vm01 -ChangeTicket CHG-12345
...
..\..\tools\Invoke-ApprovedRemediation.ps1 -Action cleanup-temp -ResourceGroup rg-srelabvm -VmName srelabvm-vm01 -ChangeTicket CHG-12348
```
